...
namespace IT.Icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']"
	[global::Android.Runtime.Register ("it/icbpi/XPaySDK/Models/WebApi/Requests/PagamentiSincroni/ApiPagaMOTORequest", DoNotGenerateAcw=true)]
	public partial class ApiPagaMOTORequest : global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ApiBaseRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("it/icbpi/XPaySDK/Models/WebApi/Requests/PagamentiSincroni/ApiPagaMOTORequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ApiPagaMOTORequest); }
		}

		protected ApiPagaMOTORequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_Lit_icbpi_XPaySDK_Models_Card_JILjava_lang_String_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']/constructor[@name='ApiPagaMOTORequest' and count(parameter)=8 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='it.icbpi.XPaySDK.Models.Card'] and parameter[4][@type='long'] and parameter[5][@type='int'] and parameter[6][@type='java.lang.String'] and parameter[7][@type='java.lang.String'] and parameter[8][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Lit/icbpi/XPaySDK/Models/Card;JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe ApiPagaMOTORequest (string p0, string p1, global::IT.Icbpi.XPaySDK.Models.Card p2, long p3, int p4, string p5, string p6, string p7)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ApiPagaMOTORequest)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/lang/String;Ljava/lang/String;Lit/icbpi/XPaySDK/Models/Card;JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Ljava/lang/String;Ljava/lang/String;Lit/icbpi/XPaySDK/Models/Card;JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", __args);
					return;
				}

				if (id_ctor_Ljava_lang_String_Ljava_lang_String_Lit_icbpi_XPaySDK_Models_Card_JILjava_lang_String_Ljava_lang_String_Ljava_lang_String_ == IntPtr.Zero)
					id_ctor_Ljava_lang_String_Ljava_lang_String_Lit_icbpi_XPaySDK_Models_Card_JILjava_lang_String_Ljava_lang_String_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/lang/String;Ljava/lang/String;Lit/icbpi/XPaySDK/Models/Card;JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_lang_String_Ljava_lang_String_Lit_icbpi_XPaySDK_Models_Card_JILjava_lang_String_Ljava_lang_String_Ljava_lang_String_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Ljava_lang_String_Ljava_lang_String_Lit_icbpi_XPaySDK_Models_Card_JILjava_lang_String_Ljava_lang_String_Ljava_lang_String_, __args);
			} finally {
...
#pragma warning disable 0169
		...
		{
			global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni.ApiPagaMOTORequest __this = global::Java.Lang.Object.GetObject<global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni.ApiPagaMOTORequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe long Amount {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']/method[@name='getAmount' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string CodTrans {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']/method[@name='getCodTrans' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Currency {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']/method[@name='getCurrency' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Cvc {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']/method[@name='getCvc' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Email {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']/method[@name='getEmail' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Expire {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']/method[@name='getExpire' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Pan {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']/method[@name='getPan' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Surname {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaMOTORequest']/method[@name='getSurname' and count(parameter)=0]"
