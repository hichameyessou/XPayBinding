...
namespace IT.Icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza']/class[@name='ApiAggiungiBlackListRequest']"
	[global::Android.Runtime.Register ("it/icbpi/XPaySDK/Models/WebApi/Requests/ControlliSicurezza/ApiAggiungiBlackListRequest", DoNotGenerateAcw=true)]
	public partial class ApiAggiungiBlackListRequest : global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ApiBaseRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("it/icbpi/XPaySDK/Models/WebApi/Requests/ControlliSicurezza/ApiAggiungiBlackListRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ApiAggiungiBlackListRequest); }
		}

		protected ApiAggiungiBlackListRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza']/class[@name='ApiAggiungiBlackListRequest']/constructor[@name='ApiAggiungiBlackListRequest' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe ApiAggiungiBlackListRequest (string p0, string p1, string p2, string p3)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ApiAggiungiBlackListRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza.ApiAggiungiBlackListRequest __this = global::Java.Lang.Object.GetObject<global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza.ApiAggiungiBlackListRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string Description {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza']/class[@name='ApiAggiungiBlackListRequest']/method[@name='getDescription' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza']/class[@name='ApiAggiungiBlackListRequest']/method[@name='getType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Value {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza']/class[@name='ApiAggiungiBlackListRequest']/method[@name='getValue' and count(parameter)=0]"
