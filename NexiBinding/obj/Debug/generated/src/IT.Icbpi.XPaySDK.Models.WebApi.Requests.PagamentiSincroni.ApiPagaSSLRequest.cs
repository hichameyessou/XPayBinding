...
namespace IT.Icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaSSLRequest']"
	[global::Android.Runtime.Register ("it/icbpi/XPaySDK/Models/WebApi/Requests/PagamentiSincroni/ApiPagaSSLRequest", DoNotGenerateAcw=true)]
	public partial class ApiPagaSSLRequest : global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ApiBaseRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("it/icbpi/XPaySDK/Models/WebApi/Requests/PagamentiSincroni/ApiPagaSSLRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ApiPagaSSLRequest); }
		}

		protected ApiPagaSSLRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_Lit_icbpi_XPaySDK_Models_Card_JI;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaSSLRequest']/constructor[@name='ApiPagaSSLRequest' and count(parameter)=5 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='it.icbpi.XPaySDK.Models.Card'] and parameter[4][@type='long'] and parameter[5][@type='int']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Lit/icbpi/XPaySDK/Models/Card;JI)V", "")]
		public unsafe ApiPagaSSLRequest (string p0, string p1, global::IT.Icbpi.XPaySDK.Models.Card p2, long p3, int p4)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ApiPagaSSLRequest)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/lang/String;Ljava/lang/String;Lit/icbpi/XPaySDK/Models/Card;JI)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Ljava/lang/String;Ljava/lang/String;Lit/icbpi/XPaySDK/Models/Card;JI)V", __args);
					return;
				}

				if (id_ctor_Ljava_lang_String_Ljava_lang_String_Lit_icbpi_XPaySDK_Models_Card_JI == IntPtr.Zero)
					id_ctor_Ljava_lang_String_Ljava_lang_String_Lit_icbpi_XPaySDK_Models_Card_JI = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/lang/String;Ljava/lang/String;Lit/icbpi/XPaySDK/Models/Card;JI)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_lang_String_Ljava_lang_String_Lit_icbpi_XPaySDK_Models_Card_JI, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Ljava_lang_String_Ljava_lang_String_Lit_icbpi_XPaySDK_Models_Card_JI, __args);
			} finally {
...
#pragma warning disable 0169
		...
		{
			global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni.ApiPagaSSLRequest __this = global::Java.Lang.Object.GetObject<global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni.ApiPagaSSLRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe long Amount {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaSSLRequest']/method[@name='getAmount' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string CodTrans {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaSSLRequest']/method[@name='getCodTrans' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Currency {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaSSLRequest']/method[@name='getCurrency' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Cvc {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaSSLRequest']/method[@name='getCvc' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Expire {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaSSLRequest']/method[@name='getExpire' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Pan {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.PagamentiSincroni']/class[@name='ApiPagaSSLRequest']/method[@name='getPan' and count(parameter)=0]"
