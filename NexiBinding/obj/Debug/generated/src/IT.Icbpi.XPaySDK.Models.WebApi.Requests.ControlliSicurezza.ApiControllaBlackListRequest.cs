...
namespace IT.Icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza']/class[@name='ApiControllaBlackListRequest']"
	[global::Android.Runtime.Register ("it/icbpi/XPaySDK/Models/WebApi/Requests/ControlliSicurezza/ApiControllaBlackListRequest", DoNotGenerateAcw=true)]
	public partial class ApiControllaBlackListRequest : global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ApiBaseRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("it/icbpi/XPaySDK/Models/WebApi/Requests/ControlliSicurezza/ApiControllaBlackListRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ApiControllaBlackListRequest); }
		}

		protected ApiControllaBlackListRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza']/class[@name='ApiControllaBlackListRequest']/constructor[@name='ApiControllaBlackListRequest' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe ApiControllaBlackListRequest (string p0, string p1, string p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ApiControllaBlackListRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza.ApiControllaBlackListRequest __this = global::Java.Lang.Object.GetObject<global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza.ApiControllaBlackListRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza']/class[@name='ApiControllaBlackListRequest']/method[@name='getType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Value {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.ControlliSicurezza']/class[@name='ApiControllaBlackListRequest']/method[@name='getValue' and count(parameter)=0]"
