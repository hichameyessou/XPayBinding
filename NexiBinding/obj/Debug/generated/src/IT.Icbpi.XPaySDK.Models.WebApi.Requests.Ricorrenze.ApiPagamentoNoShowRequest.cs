...
namespace IT.Icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze']/class[@name='ApiPagamentoNoShowRequest']"
	[global::Android.Runtime.Register ("it/icbpi/XPaySDK/Models/WebApi/Requests/Ricorrenze/ApiPagamentoNoShowRequest", DoNotGenerateAcw=true)]
	public partial class ApiPagamentoNoShowRequest : global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ApiBaseRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("it/icbpi/XPaySDK/Models/WebApi/Requests/Ricorrenze/ApiPagamentoNoShowRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ApiPagamentoNoShowRequest); }
		}

		protected ApiPagamentoNoShowRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_JIIILjava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze']/class[@name='ApiPagamentoNoShowRequest']/constructor[@name='ApiPagamentoNoShowRequest' and count(parameter)=8 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='long'] and parameter[5][@type='int'] and parameter[6][@type='int'] and parameter[7][@type='int'] and parameter[8][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JIIILjava/lang/String;)V", "")]
		public unsafe ApiPagamentoNoShowRequest (string p0, string p1, string p2, long p3, int p4, int p5, int p6, string p7)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ApiPagamentoNoShowRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze.ApiPagamentoNoShowRequest __this = global::Java.Lang.Object.GetObject<global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze.ApiPagamentoNoShowRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe long Amount {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze']/class[@name='ApiPagamentoNoShowRequest']/method[@name='getAmount' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string CodTrans {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze']/class[@name='ApiPagamentoNoShowRequest']/method[@name='getCodTrans' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Currency {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze']/class[@name='ApiPagamentoNoShowRequest']/method[@name='getCurrency' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Expire {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze']/class[@name='ApiPagamentoNoShowRequest']/method[@name='getExpire' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string GroupCode {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze']/class[@name='ApiPagamentoNoShowRequest']/method[@name='getGroupCode' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string NContract {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.Ricorrenze']/class[@name='ApiPagamentoNoShowRequest']/method[@name='getNContract' and count(parameter)=0]"
