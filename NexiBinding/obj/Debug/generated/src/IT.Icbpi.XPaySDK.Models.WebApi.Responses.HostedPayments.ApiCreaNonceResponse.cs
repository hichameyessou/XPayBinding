...
namespace IT.Icbpi.XPaySDK.Models.WebApi.Responses.HostedPayments {

	// Metadata.xml XPath class reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Responses.HostedPayments']/class[@name='ApiCreaNonceResponse']"
	[global::Android.Runtime.Register ("it/icbpi/XPaySDK/Models/WebApi/Responses/HostedPayments/ApiCreaNonceResponse", DoNotGenerateAcw=true)]
	public partial class ApiCreaNonceResponse : global::IT.Icbpi.XPaySDK.Models.WebApi.Responses.ApiBaseResponse {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("it/icbpi/XPaySDK/Models/WebApi/Responses/HostedPayments/ApiCreaNonceResponse", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ApiCreaNonceResponse); }
		}

		protected ApiCreaNonceResponse (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Responses.HostedPayments']/class[@name='ApiCreaNonceResponse']/constructor[@name='ApiCreaNonceResponse' and count(parameter)=5 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String'] and parameter[5][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe ApiCreaNonceResponse (string p0, string p1, string p2, string p3, string p4)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ApiCreaNonceResponse)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::IT.Icbpi.XPaySDK.Models.WebApi.Responses.HostedPayments.ApiCreaNonceResponse __this = global::Java.Lang.Object.GetObject<global::IT.Icbpi.XPaySDK.Models.WebApi.Responses.HostedPayments.ApiCreaNonceResponse> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string HtmlFromApi {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Responses.HostedPayments']/class[@name='ApiCreaNonceResponse']/method[@name='getHtmlFromApi' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Nonce {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Responses.HostedPayments']/class[@name='ApiCreaNonceResponse']/method[@name='getNonce' and count(parameter)=0]"
