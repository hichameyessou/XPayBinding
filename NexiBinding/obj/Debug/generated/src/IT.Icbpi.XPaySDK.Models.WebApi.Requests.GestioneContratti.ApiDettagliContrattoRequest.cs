...
namespace IT.Icbpi.XPaySDK.Models.WebApi.Requests.GestioneContratti {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.GestioneContratti']/class[@name='ApiDettagliContrattoRequest']"
	[global::Android.Runtime.Register ("it/icbpi/XPaySDK/Models/WebApi/Requests/GestioneContratti/ApiDettagliContrattoRequest", DoNotGenerateAcw=true)]
	public partial class ApiDettagliContrattoRequest : global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ApiBaseRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("it/icbpi/XPaySDK/Models/WebApi/Requests/GestioneContratti/ApiDettagliContrattoRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ApiDettagliContrattoRequest); }
		}

		protected ApiDettagliContrattoRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.GestioneContratti']/class[@name='ApiDettagliContrattoRequest']/constructor[@name='ApiDettagliContrattoRequest' and count(parameter)=5 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String'] and parameter[5][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe ApiDettagliContrattoRequest (string p0, string p1, string p2, string p3, string p4)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ApiDettagliContrattoRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.GestioneContratti.ApiDettagliContrattoRequest __this = global::Java.Lang.Object.GetObject<global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.GestioneContratti.ApiDettagliContrattoRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string DRegistrationFrom {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.GestioneContratti']/class[@name='ApiDettagliContrattoRequest']/method[@name='getDRegistrationFrom' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string DRegistrationTo {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.GestioneContratti']/class[@name='ApiDettagliContrattoRequest']/method[@name='getDRegistrationTo' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string NContract {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.GestioneContratti']/class[@name='ApiDettagliContrattoRequest']/method[@name='getNContract' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string TaxCode {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.GestioneContratti']/class[@name='ApiDettagliContrattoRequest']/method[@name='getTaxCode' and count(parameter)=0]"
