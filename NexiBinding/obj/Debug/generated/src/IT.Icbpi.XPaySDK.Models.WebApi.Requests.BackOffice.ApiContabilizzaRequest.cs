...
namespace IT.Icbpi.XPaySDK.Models.WebApi.Requests.BackOffice {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.BackOffice']/class[@name='ApiContabilizzaRequest']"
	[global::Android.Runtime.Register ("it/icbpi/XPaySDK/Models/WebApi/Requests/BackOffice/ApiContabilizzaRequest", DoNotGenerateAcw=true)]
	public partial class ApiContabilizzaRequest : global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.ApiBaseRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("it/icbpi/XPaySDK/Models/WebApi/Requests/BackOffice/ApiContabilizzaRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ApiContabilizzaRequest); }
		}

		protected ApiContabilizzaRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_II;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.BackOffice']/class[@name='ApiContabilizzaRequest']/constructor[@name='ApiContabilizzaRequest' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;II)V", "")]
		public unsafe ApiContabilizzaRequest (string p0, string p1, int p2, int p3)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ApiContabilizzaRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.BackOffice.ApiContabilizzaRequest __this = global::Java.Lang.Object.GetObject<global::IT.Icbpi.XPaySDK.Models.WebApi.Requests.BackOffice.ApiContabilizzaRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe int Amount {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.BackOffice']/class[@name='ApiContabilizzaRequest']/method[@name='getAmount' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string CodTrans {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.BackOffice']/class[@name='ApiContabilizzaRequest']/method[@name='getCodTrans' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Currency {
			// Metadata.xml XPath method reference: path="/api/package[@name='it.icbpi.XPaySDK.Models.WebApi.Requests.BackOffice']/class[@name='ApiContabilizzaRequest']/method[@name='getCurrency' and count(parameter)=0]"
